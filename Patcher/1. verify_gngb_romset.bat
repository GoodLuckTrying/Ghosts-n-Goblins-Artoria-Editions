...
set "filename=gng.n10" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul') do echo [PASS] !filename! - CRC32: %%h & set /a passed_count+=1)
set "filename=gng.n9" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul') do echo [PASS] !filename! - CRC32: %%h & set /a passed_count+=1)
set "filename=gng.n8" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul') do echo [PASS] !filename! - CRC32: %%h & set /a passed_count+=1)
set "filename=gng.n13" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul') do echo [PASS] !filename! - CRC32: %%h & set /a passed_count+=1)
set "filename=gng.n12" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul') do echo [PASS] !filename! - CRC32: %%h & set /a passed_count+=1)
